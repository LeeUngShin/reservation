...
//                "test.jpg",
//                "image/jpeg",
//                "Test image content".getBytes()  // 파일 내용을 바이트 배열로 전달
//        );
...
//        fitDTO.setFileAttached(1);
//        fitDTO.setFitFile(multipartFileList);
...
//            }
//        }
//        insertFitFile(fitNum, multipartFile);
//    }
//
//    @Test
//    void insertFitFile(Long gymNum, MultipartFile multipartFile){
//        FitFileDTO fitFileDTO = new FitFileDTO();
//        fitFileDTO.setFitNum(gymNum);
//        fitFileDTO.setOriginalFileName(multipartFile.getOriginalFilename());
//        fitFileDTO.setStoredFileName(multipartFile.getOriginalFilename()+"_test");
//        fitMapper.insertFitFile(fitFileDTO);
//    }
//
//    @Test
//    void selectFit() {
...
//    void selectFitFile() {
//        FitFileDTO fitFileDTO = new FitFileDTO();
//        //List<FitFileDTO> fitFileDTOS = fitMapper.selectFitFile(18L);
//        System.out.println("18번체육시설파일 : " + fitFileDTOS);
//    }
//
//    @Test
//    void updateFit() {
